...
-- changeset wladw:1758451325798-2
CREATE TABLE character_inventory_item
(
    id           BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    inventory_id BIGINT,
    item_id      BIGINT,
    CONSTRAINT pk_character_inventory_item PRIMARY KEY (id)
);
...
-- changeset wladw:1758451325798-3
ALTER TABLE character_inventory_item
    ADD CONSTRAINT FK_CHARACTER_INVENTORY_ITEM_ON_INVENTORY FOREIGN KEY (inventory_id) REFERENCES character_inventory (id);

-- changeset wladw:1758451325798-4
ALTER TABLE character_inventory_item
    ADD CONSTRAINT FK_CHARACTER_INVENTORY_ITEM_ON_ITEM FOREIGN KEY (item_id) REFERENCES items (id);
